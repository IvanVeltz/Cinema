...
<form action="index.php?action=modifRealisateur&id=<?=$realisateur['id_personne']?>" method="post" id="formModifier" style="display : none;">
            <div class="input-group mb-3">
                <label>Modifier le realisateur</label>
            </div>
            <div>
